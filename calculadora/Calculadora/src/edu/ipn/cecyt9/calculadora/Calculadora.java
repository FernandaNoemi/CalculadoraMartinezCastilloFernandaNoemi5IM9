...
public class Calculadora extends JFrame {
	...
	public Calculadora() {
		super();
		setSize(500, 500);
		setTitle("Martínez Castillo Fernanda Noemí 5IM9");
		...
		nuevoBotonOperacion("=");
                ...
                nuevoBotonOperacion("Raíz");
                nuevoBotonOperacion("Sin");
                nuevoBotonOperacion("Tan");
                nuevoBotonOperacion("To °");
                nuevoBotonOperacion("To Rad");
	...
	private void calcularResultado() {
		...
		} else if (operacion.equals("To °")) {
                    resultado=Math.toDegrees(new Double(pantalla.getText()));
		} else if (operacion.equals("To Rad")) {
                    resultado=Math.toDegrees(new Double(pantalla.getText()));
		}
